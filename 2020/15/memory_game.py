...
Part two takes 9 seconds to run when using a dictionary,
now 5 seconds after switching to a list for lookups.
"""
...
def memory_game(nums, target=2020):
    idx = [-1] * (target + 1)  # index of last instance of each number
